...
#define lwip_strnicmp					strncasecmp		// described in lwIP2.0.2 to be needed - but not used in 2.1.2 (?)
...
/**
 * We already have some builtin functions that do the byte swapping (gcc)
 */
...
/**
 * RAW_TTL: Default value for Time-To-Live used by RAW packets.
 */
 ...
 */
#define TCP_DEFAULT_LISTEN_BACKLOG      0x20
...
//#define LWIP_TCPIP_THREAD_ALIVE()	sys_tcpip_alive()
...
#define LWIP_MARK_TCPIP_THREAD()	sys_tcpip_started();
...
//sys_sem_t *sys_netconn_thread_sem_get(void);
//void sys_netconn_thread_sem_alloc(void);
//void sys_netconn_thread_sem_free(void);
//#define LWIP_NETCONN_THREAD_SEM_GET sys_netconn_thread_sem_get
//#define LWIP_NETCONN_THREAD_SEM_ALLOC sys_netconn_thread_sem_alloc
//#define LWIP_NETCONN_THREAD_SEM_FREE sys_netconn_thread_sem_free
